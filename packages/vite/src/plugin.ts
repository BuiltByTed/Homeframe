...
import { bootSplashMarkup, splashBootstrap } from './splash.js';
import type {
  GeneratedHomeframeAsset,
  HomeframeConfig,
  HomeframeSplashConfig,
  ...
  return {
    ...
    async transformIndexHtml(html) {
      ...
      const boot = bootScript({
        ...
        appleStatusBarStyle,
        splash: { ...config.splash, appleStatusBarStyle },
        serviceWorkerUrl,
...
function bootScript(info: {
  ...
  splash: HomeframeSplashConfig | undefined;

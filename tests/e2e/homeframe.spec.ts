...
test('route navigation preserves one opaque, unfiltered header and one active primary scroller', async ({ page }) => {
  ...
  await expect(page.locator('[data-hf-scroll-view]')).toHaveCount(1);
